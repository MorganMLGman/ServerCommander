...
If you are running YunoHost you can see how many users, backups and domains have. Also there is possibility how many applications are waiting for an update and you can list them. You can `push` new ssh keys for chosen user.
